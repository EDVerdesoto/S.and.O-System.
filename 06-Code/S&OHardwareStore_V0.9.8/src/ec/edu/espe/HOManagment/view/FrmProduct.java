...
public class FrmProduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dtcIncomeProduct = new com.toedter.calendar.JDateChooser();
        ...
        jPanel3.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 10, -1, -1));
        ...
        jPanel3.add(dtcIncomeProduct, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 120, 130, -1));
    ...
    private void btnAddProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddProductActionPerformed
        ...
        income = formDate.format(dtcIncomeProduct.getDate());
        price = Float.parseFloat(txtPrice.getText());
        stock = Integer.parseInt(txtStock.getText());

        Product product = new Product(name, price, formDate.format(dtcIncomeProduct.getDate()), stock);
    ...
    private com.toedter.calendar.JDateChooser dtcIncomeProduct;
