...
public class FrmUpdateSupplier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(105, 145, 172));
        ...
        jPanel1.add(txtinvoiceNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 240, 130, -1));
    ...
    private void txtinvoiceNumberKeyTyped(java.awt.event.KeyEvent evt){
        char validar = evt.getKeyChar();
        if(Character.isLetter(validar)){
            getToolkit().beep();
